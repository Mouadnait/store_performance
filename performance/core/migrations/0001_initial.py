...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price', models.DecimalField(decimal_places=2, default=0.0, max_digits=99999999999)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default=0.0, max_digits=99999999999)),
                ('total', models.DecimalField(decimal_places=2, default=0.0, max_digits=99999999999)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sku', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefgh12345', length=4, max_length=10, prefix='', unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, default='This is a Vender description', null=True)),
                ('address', models.CharField(default='123 Main Street', max_length=100)),
                ('contact', models.CharField(default='+212 655 1212', max_length=100)),
                ('chat_resp_time', models.CharField(default='100', max_length=100)),
                ('chipping_on_time', models.CharField(default='100', max_length=100)),
